...
STACK_TOP = $06 ; Value of top of stack pointer
...
REG3 = $5002    ; Register 2 memory location
REG2 = $5003    ; placeholder. No register here
...
; pla above .print: $8016

; All below have pla below .print
; pla below .print: $8116

; no print_char: $8016
; A replace print_char with lcd_wait: $8116
; as A, remove pha/pla from lcd_wait: $8116
; as A, keep pha/pla in lcd_wait, skip everything else: $8116
; as A, lcd_wait rts immediately: $8116
; B keep print_char
; as B, rts immediately: $8116
